        ...
        <div class="order-details-inner">
            <div class="dashboard-head-widget style-2">
                ...
                <div class="dashboard-head-widget-btn">
                    <a class="theme-btn secondary-btn icon-right" href="{{route('user.order')}}"><i class="fi-rr-arrow-left"></i>Back to orders</a>
                </div>
            </div>
            <div class="order-details-inner">
                    ...
                    <div class="order-details-info-head">
                        ...
                        <div class="od-info-head-duration">
                            <ul>
                                ...
                                <li>
                                    Delivery:<span> {{$order->delivery_date ?? ' Standard Delivery (3-7 days)'}} </span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="order-details-info-card-group">
                        ...
                        <div class="order-d-info-tracking-card">
                            ...
                            <div class="order-d-info-tracking-card-content">
                                ...
                                <a class="theme-btn" href="{{route('order.tracking')}}">Track parcel<i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-od-package">
                            <div class="order-summary-head">
                                <h4 class="order-summary-head-title">
                                    <img alt="#" src="{{asset('user/assets/img/icons/humberger.svg')}}" />Order summary
                                </h4>
                            </div>
                            ...
                            <div class="od-package-item">
                                <div class="od-package-info">
                                    @if ($detail->product)
                                    <img src="{{ url(env('ADMIN_URL') . '/' . $detail->product->image) }}" alt="#" />
                                    <a href="#">
                                ...
                                <div class="od-package-item-list">
                                    ...
                                    <div class="single-od-package-item total">
                                        <p>
                                            Total:<span> {{$detail->total_price*$detail->qty}} TK</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="od-package-footer">
                                ...
                                <div class="od-package-fotter-right">
                                    <a href="#" class="review-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Write a
                                        review</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="order-summary-total">
                ...
                <ul class="order-summary-total-list">
                    ...
                    <li class="total-price">
                        Total<strong>{{$order->sub_total+$order->delivery_fee-$order->discount}} TK</strong>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="write-review-modal cancelled-order-modal modal fade" id="cancelOrderModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
...
<div class="write-review-modal cancelled-order-modal return-product-modal modal fade" id="returnProductModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="can-order-modal-head">
                <h4>How can we help you?</h4>
                ...
                <form action="#" method="post" class="can-order-modal-form write-review-form">
                    <div class="can-order-modal-form-inner">
                        ...
                        <div class="form-group" id="upload-container">
                            <div class="create-ticket-form-upload-image">
                                <div class="library-photo-input">
                                    <input type="file" accept="image/*" id="library-photo-input2" class="hidden" multiple onchange="uploadLibraryPhoto(event, 2)" />

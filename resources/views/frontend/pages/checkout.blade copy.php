                ...
                <div class="col-lg-6 col-xl-4 col-12">
                    <div class="checkout-personal-details single-details-box">
                            ...
                            <div class="single-details-checkout-widget-head">
                                ...
                                <div class="change-address-btn">
                                    <a class="theme-btn" href="#" data-bs-toggle="modal"
                                        data-bs-target="#changeAddress"><i class="fi-br-refresh"></i>Change address</a>
                                </div>
                            </div>

                            <div class="c-personal-details-box single-details-box-inner">
                                @if ($userAddress && ($billingAddress = $userAddress->firstWhere('address_type', 'Home')))
                                ...
                                @else
                                    <div class="billing-address-div new-user-address-widget">
                                        ...
                                        <div class="manage-address-add-address">
                                            <a class="theme-btn" href="#" data-bs-toggle="modal"
                                                data-bs-target="#addNewAddress2"><i class="fi-br-plus"></i>Add new
                                                address</a>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="single-details-checkout-widget">
                            ...
                            <div class="c-personal-details-box single-details-box-inner">
                                @if ($userAddress && ($shippingAddress = $userAddress->firstWhere('address_type', 'Office')))
                                    ...
                                    <div class="payment-method-input">
                                        <label for="flexRadioDefault1">
                                            <div class="payment-method-input-main">
                                                <input class="form-check-input" type="radio" checked name="cod"
                                        ...
                                        <label for="flexRadioDefault2">
                                            <div class="payment-method-input-main">
                                                <input class="form-check-input" type="radio" name="ssl_commerz"
                                        ...
                                        <label for="flexRadioDefault3">
                                            <div class="payment-method-input-main">
                                                <input class="form-check-input" type="radio" name="bkash"
                                ...
                                <div class="checkout-payment-method-inner single-details-box-inner">
                                    <div class="payment-method-input">
                                        <label for="flexRadioDefault4">
                                            <div class="payment-method-input-main">
                                                <input class="form-check-input" type="radio" name="home_delivery"
                                        ...
                                        <label for="flexRadioDefault5">
                                            <div class="payment-method-input-main">
                                                <input class="form-check-input" type="radio" name="store_pickup"
                                            ...
                                            <div class="club-points-form">
                                                ...
                                                <div class="checkout-checkbox-details">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="flexCheckChecked3" value="" /><label
                                                        class="form-check-label" for="flexCheckChecked3">Use maximum <b>82
                                                            Club Points</b></label>
                                                </div>
                            ...
                            <div class="order-review-summary">
                                <div class="cart-order-summary-main">
                                    <ul class="cart-order-summary-main-list">
                                        ...
                                        <li>Delivery cost <span id="delivery-cost-display">420.00 BDT</span></li>
                                    </ul>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="checkout-checkbox-details">
                                        ...
                                        <label class="form-check-label" for="flexCheckChecked2">I have read and agree to
                                            the
                                            <a href="#">Terms and Conditions</a>, <a href="#">Privacy
                                                Policy</a>, and <a href="#">Refund and Return Policy</a>.
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">

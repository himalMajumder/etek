      ...
      <div class="col-lg-6">
        <div class="about__thumb d-flex">
          ...
          <div class="about__thumb--items">
            <img class="about__thumb--img border-radius-5 display-block" src="{{ url(env('ADMIN_URL') . '/' . $about->image) }}" alt="about-thumb" />
          </div>


          <div class="about__thumb--items position__relative">
            <img class="about__thumb--img border-radius-5 display-block" src="{{ url(env('ADMIN_URL') . '/' . $about->banner_bg) }}" alt="about-thumb" />
        ...
        <div class="swiper-slide">
          <div class="testimonial__items text-center">
            <div class="testimonial__items--thumbnail">
              <img class="testimonial__items--thumbnail__img border-radius-50" src="{{ url(env('ADMIN_URL') . '/' . $testimonial->customer_image) }}" alt="testimonial-img" />
            </div>
            <div class="testimonial__items--content">
              <h3 class="testimonial__items--title">
                {{ $testimonial->customer_name ?? 'N/A' }}
              </h3>
              <span class="testimonial__items--subtitle">{{ $testimonial->designation ?? 'N/A' }}</span>
      ...
      <div class="col">
        <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
          ...
          <div class="brand__logo--items">
            <img class="brand__logo--items__thumbnail--img display-block" src="{{ url(env('ADMIN_URL') . '/' . $brand->logo) }}" alt="brand logo" />
          </div>
          @endforeach

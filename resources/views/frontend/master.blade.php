                                        ...
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                ...
                                                href="{{ asset('assets/img/product/big-product4.jpg') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('product/big-product4.jpg') }}"
                                                    alt="product-media-img" /></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/img/product/small-product7.png') }}"
                                                alt="product-nav-img" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/img/product/small-product8.png') }}"
                                                alt="product-nav-img" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/img/product/small-product9.png') }}"
                                                alt="product-nav-img" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/img/product/small-product10.png') }}"
                                                alt="product-nav-img" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/img/product/small-product11.png') }}"
                                                alt="product-nav-img" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/img/product/small-product12.png') }}"
                                                alt="product-nav-img" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="product__variant">
                                    <div class="product__variant--list mb-10">
                                        <fieldset class="variant__input--fieldset color-field">
                                            ...
                                            <input id="option1" name="options" type="radio" class="btn-check"
                                                checked="" />
                                            <label class="variant__color--value red btn btn-secondary" for="option1"
                                                title="Red"></label>
                                            <input id="option2" class="btn-check" name="options" type="radio" />
                                            <label class="variant__color--value black btn btn-secondary"
                                                for="option2" title="Black"></label>
                                            <input id="option3" class="btn-check" name="options" type="radio" />
                                            <label class="variant__color--value pink btn btn-secondary" for="option3"
                                                title="Pink"></label>
                                        </fieldset>
                                    </div>

...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ url(env('ADMIN_URL') . '/' . $generalinfos->fav_icon) }}" />

    <!-- Title -->
    <title>{{$generalinfos->tab_title}}</title>

    <meta name="description" content="Explore the latest electronics at our online store! From smartphones to smart home devices, find top-quality gadgets at competitive prices. Shop now for unbeatable deals and fast delivery." />
    <meta name="keywords" content="Electronics online store,Buy electronics online,Gadgets shop,Smartphone deals" />

    <!-- Meta OG Tags -->
    <meta property="og:site_name" content="Explore the latest electronics at our online store! From smartphones to smart home devices, find top-quality gadgets at competitive prices. Shop now for unbeatable deals and fast delivery." />
    <meta property="og:title" content="Explore the latest electronics at our online store! From smartphones to smart home devices, find top-quality gadgets at competitive prices. Shop now for unbeatable deals and fast delivery." />
    <meta property="og:description" content="Explore the latest electronics at our online store! From smartphones to smart home devices, find top-quality gadgets at competitive prices. Shop now for unbeatable deals and fast delivery." />
    ...
    <link rel="stylesheet" href="{{asset('assets/css/plugins/uicons.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/css/plugins/icofont.css')}}" />
    ...
    <!-- Maginific Popup CSS -->
    <link rel="stylesheet" href="{{asset('user/assets/css/plugins/maginific-popup.min.css')}}" />
    <!-- FancyBox CSS -->
    ...
    <!-- Glightbox CSS-->
    <link rel="stylesheet" href="{{asset('user/assets/css/plugins/glightbox.min.css')}}" />
    <!-- Main CSS -->
    <link rel="stylesheet" href="{{asset('user/assets/css/plugins/datepicker.css')}}" />
    <!-- Main CSS -->
...
<body>
    ...
    <div class="compare-icon-fixed">
        <a href="{{route('frontend.compare')}}"><i class="fi fi-rs-code-compare"></i></a>
    </div>

    <!-- WhatsApp Floating Button -->
    <div class="floating_btn">
        <a target="_blank" href="https://api.whatsapp.com/send?phone=8801730797262&text=Hi%20there!%20I%27m%20Mostaim%20Billah%20Murad%20from%20GetUp%20Limited.%20I%20would%20be%20glad%20to%20assist%20you%20in%20any%20way%20I%20can">
            ...
            <div class="row">
                <div class="col-xl-7 col-md-6 col-9">
                    <div class="topbar-notice-inner">
                        <span>Update</span>
                        <marquee behavior="" direction="left">23rd April Wednesday, all outlets are open except USA.
                            Additionally, our online activities are open and
                            operational.</marquee>
                    </div>
                </div>
                <div class="col-xl-5 col-md-6 col-3">
                    <div class="topbar-right">
                        <ul class="topbar-info">
                            <li>
                                <a href="tel:+8801812345678"><i class="fi fi-rr-phone-call"></i>{{ $generalinfos->contact }}</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="getcom-user-body-bg">
                            <img alt="#" src="./assets/img/user-hero-bg.png" />
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <!-- Quickview Wrapper -->
    <div class="modal quick-view-modal" id="modal1" data-animation="slideInUp">
                        ...
                        <div class="quickview__product--media product__details--media">
                            <div class="product__media--preview swiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('assets/img/product/big-product2.jpg')}}"><img class="product__media--preview__items--img" src="{{asset('assets/img/product/big-product2.jpg')}}" alt="product-media-img" /></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{asset('assets/img/product/big-product2.jpg')}}" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512">
                                                        <path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path>
                                                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path>
                                                    </svg>
    ...
    <script src="{{asset('user/assets/js/vendor/popper.js')}}" defer="defer"></script>
    <!-- <script src="{{asset('user/assets/js/vendor/bootstrap.min.js')}}" defer="defer"></script> -->
    <!-- <script src="{{asset('user/assets/js/plugins/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('user/assets/js/plugins/nice-select.js')}}"></script> -->
    <script src="{{asset('user/assets/js/plugins/jquery-fancybox.min.js')}}"></script>
    <!-- <script src="{{asset('user/assets/js/plugins/glightbox.min.js')}}"></script> -->
    <!-- <script src="{{asset('user/assets/js/plugins/bootstrap-datepicker.js')}}"></script> -->
    <!-- <script src="{{asset('user/assets/js/plugins/active.js')}}"></script> -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const collapseButtons = document.querySelectorAll('.menu-collapse-button');
            ...
            collapseButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    if (targetMenu.classList.contains('active')) {
                        ...
                        document.querySelectorAll('.menu-collapse-list.active').forEach(menu => {
